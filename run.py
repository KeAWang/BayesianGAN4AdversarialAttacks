...
x = "python bayesian_gan_hmc.py --out_dir \'results\' --semi_supervised --save_samples --wasserstein --dataset mnist --adv_test --data_path \'\' --n_save 100 --num_mcmc 2  --numz 10 --custom_experiment "+experiment_name+" --save_chkpt "+str(epoch_size)
